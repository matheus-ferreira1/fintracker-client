...
const { data, pending, error } = useAPI<ApiResponse<Category[]>>(`/categories?type=${CategoryTypeEnum.EXPENSE}`, { key: `${CategoryTypeEnum.EXPENSE}-categories`, cache: 'force-cache' })
